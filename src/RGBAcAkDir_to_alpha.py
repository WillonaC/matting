...
#        data = data_rgb * data_rgb3 
    data = data_rgb/255.0
    # R G B Ac Ak Dirx Diry DirConfi
    data = np.concatenate([data[:,:,0].reshape(data_rgb.shape[0],data_rgb.shape[1],1), 
                           ...
                           data_direction[:,:,0].reshape(data_rgb.shape[0],data_rgb.shape[1],1), 
                           data_direction[:,:,1].reshape(data_rgb.shape[0],data_rgb.shape[1],1), 
                           data_direction[:,:,2].reshape(data_rgb.shape[0],data_rgb.shape[1],1)],
                        axis=2)
